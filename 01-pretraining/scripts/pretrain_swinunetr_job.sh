#!/bin/bash
#SBATCH --job-name=pretrain_swinunetr
#SBATCH --output=../output/logs/pretrain_swinunetr_%j.out
#SBATCH --error=../output/logs/pretrain_swinunetr_%j.err
...
# pretrain_swinunetr_job.sh - Script to run SwinUNETR pretraining
...
# indicate starting
echo "Starting LSM SwinUNETR pretraining..."
...
CONFIG_PATH="pretrain_swinunetr_config.yaml"
...
# run script
srun --label python pretrain_swinunetr.py --config $CONFIG_PATH



# indicate completion
echo 'LSM SwinUNETR pretraining complete'
