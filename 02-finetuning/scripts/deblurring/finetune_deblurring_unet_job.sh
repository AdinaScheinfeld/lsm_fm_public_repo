...
#SBATCH --output=../../output/logs/finetune_deblur_unet_%j.out
#SBATCH --error=../../output/logs/finetune_deblur_unet_%j.err
...
# finetune_deblurring_unet_job.sh - SLURM script for UNet deblurring finetuning
...
echo "Starting LSM UNet deblurring finetuning..."
...
# path to config file
CONFIG_PATH="finetune_deblurring_unet_config.yaml"
...
# run finetuning
srun --label python finetune_deblurring_unet.py --config "$CONFIG_PATH"
...
echo "LSM UNet deblurring finetuning complete."
